...
public class main {
	...
	public static void main(String[] args) {
		...
		*/
		...
		{
			if(carList.get(i).getSeats() >= passengers)
		...
		for (int i = 0; i <  potentialCars.size(); i++)
		{
			...
			System.out.println("\n" + "The comfort level is: " + potentialCars.get(i).getComfortLevel());
			double temp = (double)Math.round(((potentialCars.get(i).getCost() * (days - (days/6))) + (2.25 * approxMiles)) * 100) / 100;
